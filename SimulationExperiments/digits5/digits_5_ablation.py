...
'''
nohup /local/home/sfoell/GitHub/gdu-old/SimulationExperiments/digits5/digits_5_ablation.py >/local/home/sfoell/GitHub/gdu-old/SimulationExperiments/digits5/2023-03-30/ablation_study_M/ols_0_sparse_0.log 2>&1 &
'''
...
res_file_dir = "/local/home/sfoell/GitHub/gdu-old/SimulationExperiments/digits5/2023-03-30/ablation_study_M/ols_0_sparse_0"
...
def digits_classification(method, TARGET_DOMAIN, single_best=False, single_source_domain=None,
    ...
    if domain_adaptation:
        ...
        lambda_OLS = domain_adaptation_spec_dict["lambda_OLS"]
        lambda_orth = domain_adaptation_spec_dict["lambda_orth"]
        lambda_sparse = domain_adaptation_spec_dict["lambda_sparse"]
    ...
    hist = model.fit(x=x_source_tr, y=y_source_tr, epochs=2, verbose=2,
    ...
    if domain_adaptation is False and fine_tune:
        ...
        for similarity_measure in ['MMD', 'cosine_similarity','projected']:
            ...
            hist = model.fit(x=x_source_tr, y=y_source_tr.astype(np.float32), epochs=2, verbose=2,
...
if __name__ == "__main__":
    ...
    #for i in [0]:
        experiments = []
        for method in ['MMD', 'cosine_similarity','projected']:
            for kernel in [None]:
                #for TEST_SOURCES in [['mnistm'], ['mnist'], ['syn'], ['svhn'], ['usps']]:
                for TEST_SOURCES in [['mnistm']]:
